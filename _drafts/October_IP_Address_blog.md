...
- TODO: add more concrete explanations of how IP addresses had (or had accused to) been used to violate privacy.

Outside of Mastodon, the stakes are also high. Hong Kong, a special administration region of the People's Republic of China, has demonstrated the importance of privacy in the Hong Kong protest during 2019-2020. In this war, lives were taken, and so were the privacy of thousands and thousands of protesters, including 4000 phones that have been seized by the police, [source](https://www.businessinsider.com/hong-kong-police-seize-cell-phones-protesters-sparking-privacy-concerns-2020-1). People were basically naked on the internet. Lokman Tsui and Stuart Hargreaves from the Chinese University of Hong Kong has [showed](https://ijoc.org/index.php/ijoc/article/view/8232/2620) that IP addresses are **not** considered protected personal data, and therefore, this "means that police do not need a warrant to request, say, a list of subscribers who were in a certain place at a certain time", [source](https://www.technologyreview.com/2019/09/10/102646/the-new-battle-in-hong-kong-isnt-on-the-streets-its-in-the-apps/).

Currently, there are no direct reports that confirms Beijing tracking and/or gaining access to these data, including IP addresses, to perform unrightful actions towards the protesters, but there are numerous reports that suspect these actions have been in the background for a long time, [source](https://www.cbc.ca/news/business/tiktok-hong-kong-1.6868141), [source](https://www.cisecurity.org/insights/blog/the-chinese-communist-party-ccp-a-quest-for-data-control), [source](https://globalvoices.org/2019/09/06/hong-kong-reddit-like-lihkg-faces-unprecedented-ddos-attacks-redirected-from-chinese-internet-companies/). The most common hypothesis is that the communist party in China have used these "gaps" in Hong Kong laws to collect data (including IP addresses) to identify the protesters. Using the authority to gather data from various companies that operates in Hong Kong/China, which includes companies like Tiktok (before they exited the Hong Kong market), WeChat, LIHKG (Hong Kong reddit), China is highly likely to have gotten access to the search history, chat history, browsing history and the IP address of everyone that uses these softwares in China or Hong Kong. With some data analysis, it is trivial to identify the identities of all current or potential protesters. Other forms of information can also be obtained by China in similar fasions, including the protesters' networks, movements, and plans for disruption. This type of digital surveillance undoubtedly makes the future for individuals' privacy gloomy and uncertain.
