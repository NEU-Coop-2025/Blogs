...
## Personal experience with algorithms
...
The deep root cause behind that is these algorithms created by these big corporations behind those platforms that just trap the users into their platform. And for the big corporations, there are so many incentives and not enough regulations that prevents them from using and abusing these kinds of algorithms to trap their users in. These corporations know that in order for the users to stay, they have to be different or at least different from what social media and other internet platforms used to be.
